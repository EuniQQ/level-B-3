...
<div class="list">
    <?php
$rows=$Ord->all("Order by  `no` DESC"); //NUMBER這個欄位由DESC方式排列
...
foreach($rows as $row){
    ...
    echo "</span>";
    echo "<span><buttoon onclick='del(&#39;ord&#39;,{$row['id']})'>刪除</buttoon></span>";
    echo "</div>";
    echo "<hr>";
}
...
// get_movie copy 改 get_ord_movie
// del copy 改 qdel